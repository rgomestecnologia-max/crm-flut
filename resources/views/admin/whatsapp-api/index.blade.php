    ...
    <div style="padding:24px;" x-data="{ tab: '{{ request('tab', 'evolution') }}' }">
        ...
        <div style="display:flex; gap:10px; margin-bottom:24px; flex-wrap:wrap;">
            <button @click="tab='evolution'"
                    ...
                    style="display:flex; align-items:center; gap:8px; padding:9px 20px; font-size:13px; font-weight:600; border:1px solid; border-radius:10px; cursor:pointer; transition:all 0.2s;">
