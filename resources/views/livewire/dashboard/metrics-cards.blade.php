<div wire:poll.120s.visible>
    <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(160px, 1fr)); gap:14px;" class="mobile-grid-2">
        ...
        if ($isManager) {
            $cards[] = ['label' => 'Novos Contatos', 'value' => $newContacts, 'color' => '#3b82f6', 'icon' => 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z'];
            $cards[] = ['label' => 'Total Abertas', 'value' => $stats['total_open'], 'color' => '#ef4444', 'icon' => 'M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4'];
        }
        @endphp
