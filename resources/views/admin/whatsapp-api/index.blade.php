<x-layouts.app>
    ...
    <div style="padding:24px;" x-data="{ tab: '{{ request('tab', 'evolution') }}' }">
        ...
        <div style="display:flex; gap:4px; margin-bottom:24px; border-bottom:1px solid rgba(255,255,255,0.06); padding-bottom:0;">
            <button @click="tab='evolution'" :style="tab==='evolution' ? 'color:#b2ff00; border-bottom:2px solid #b2ff00; background:rgba(178,255,0,0.05);' : 'color:rgba(255,255,255,0.4); border-bottom:2px solid transparent;'"
                    style="padding:10px 20px; font-size:13px; font-weight:600; border:none; cursor:pointer; transition:all 0.15s; background:transparent; border-radius:8px 8px 0 0;">
            ...
            <button @click="tab='zapi'" :style="tab==='zapi' ? 'color:#22c55e; border-bottom:2px solid #22c55e; background:rgba(34,197,94,0.05);' : 'color:rgba(255,255,255,0.4); border-bottom:2px solid transparent;'"
                    style="padding:10px 20px; font-size:13px; font-weight:600; border:none; cursor:pointer; transition:all 0.15s; background:transparent; border-radius:8px 8px 0 0;">
                <span style="display:flex; align-items:center; gap:6px;">
