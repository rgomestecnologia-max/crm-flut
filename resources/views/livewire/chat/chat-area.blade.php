                ...
                <template x-teleport="body">
                    <div x-show="open" x-transition @click.outside="open=false"
                        ...
                        <label style="display:flex; align-items:center; gap:10px; padding:10px 14px; cursor:pointer; transition:background 0.15s; border-top:1px solid rgba(255,255,255,0.04);"
                            ...
                            <input type="file" wire:model="pendingFile" @change="open=false" accept=".pdf,.doc,.docx,.xls,.xlsx,.csv,.txt,.zip,.rar,.7z,.ppt,.pptx,text/csv,application/csv,application/vnd.ms-excel" class="hidden">
                        </label>
                    </div>
                </template>
            </div>
