<div>
    ...
    <div style="display:flex; gap:10px; margin-bottom:20px; flex-wrap:wrap;">
        ...
        <button wire:click="$set('tab', '{{ $k }}')"
                style="padding:9px 20px; font-size:13px; font-weight:600; border-radius:10px; cursor:pointer; transition:all 0.2s; border:1px solid {{ $tab === $k ? 'transparent' : 'rgba(255,255,255,0.08)' }}; background:{{ $tab === $k ? 'linear-gradient(135deg,#b2ff00,#8fcc00)' : 'rgba(255,255,255,0.03)' }}; color:{{ $tab === $k ? '#111' : 'rgba(255,255,255,0.5)' }};">
            {{ $l }}
        </button>
        @endforeach
    </div>
