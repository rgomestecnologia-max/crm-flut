...
class Message extends Model
{
    ...
    public function getMediaThumbUrlAttribute(): ?string
    {
        ...
        // Vídeos: thumbnail é sempre .jpg (gerado pelo ImageOptimizer)
        // Imagens: thumbnail mantém a mesma extensão (.jpg se otimizado)
        if ($this->type === 'video') {
            return substr($url, 0, $dotPos) . '_thumb.jpg';
        }
